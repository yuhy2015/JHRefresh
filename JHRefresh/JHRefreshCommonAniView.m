...
NSString *const JHRefreshHeaderStatusTextNormal = @"下拉小宝为你刷新";
NSString *const JHRefreshHeaderStatusTextPulling = @"松开小宝为你刷新";
...
NSString *const JHRefreshFooterStatusTextPulling = @"放开以刷新";
